...
angular.module('xenon.services', []).
	service('$menuItems', function()
	{
		...
		this.prepareSidebarMenu = function(op)
		{
			...
			for(var o of op){				  
				  ...
				  var operations = o.operations

	          	  cat = this.addItem(o.category.name,'/app/'+o.category.name.toLowerCase(),o.category.icon)

	          	  for (var sub of o.operations){

	          	  		cat.addItem(sub.name,'-/'+sub.slug)				   
