...
var module = angular.module('pdp');

module.factory('ModalService', ['$animate', '$document', '$compile', '$controller', '$http', '$rootScope', '$q', '$templateRequest', '$timeout','$ocLazyLoad',
  function($animate, $document, $compile, $controller, $http, $rootScope, $q, $templateRequest, $timeout,$ocLazyLoad) {
  ...
  function ModalService() {
    ...
    self.showModal = function(options) {
      ...
      if(!options.controllerjs){

      }
      
      var deferred = $q.defer();
      
      $ocLazyLoad.load(options.controllerjs).then(function() {
